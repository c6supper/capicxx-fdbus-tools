...
class FrancaFDBusGeneratorExtensions {
    ...
    def getFDBusVersion() {
        ...
        for (b : bundleContext.bundles) {
            if (b.symbolicName.equals("org.genivi.commonapi.fdbus")) {
                return b.version
            }
        }
    }

    def generateCommonApiFDBusLicenseHeader() '''
        /*
         * This file was generated by the CommonAPI Generators.
         * Used org.genivi.commonapi.fdbus «getFDBusVersion()».
         * Used org.franca.core «FrancaGeneratorExtensions::getFrancaVersion()».
         *
         «getCommentedString(getFDBusLicenseHeader())»
         */
    '''

    def getFDBusLicenseHeader() {
        return FPreferencesFDBus::instance.getPreference(PreferenceConstantsFDBus::P_LICENSE_FDBUS, PreferenceConstantsFDBus.DEFAULT_LICENSE)
    }

    def String fdbusDeploymentHeaderFile(FInterface fInterface) {
        return fInterface.elementName + "FDBusDeployment.hpp"
    }

    def String fdbusDeploymentHeaderPath(FInterface fInterface) {
        return fInterface.versionPathPrefix + fInterface.model.directoryPath + '/' +
            fInterface.fdbusDeploymentHeaderFile
    }

    def String fdbusDeploymentSourceFile(FInterface fInterface) {
        return fInterface.elementName + "FDBusDeployment.cpp"
    }

    def String fdbusDeploymentSourcePath(FInterface fInterface) {
        return fInterface.versionPathPrefix + fInterface.model.directoryPath + '/' +
            fInterface.fdbusDeploymentSourceFile
    }

    def String fdbusDeploymentHeaderFile(FTypeCollection _tc) {
        return _tc.elementName + "FDBusDeployment.hpp"
    }

    def String fdbusDeploymentHeaderPath(FTypeCollection _tc) {
        return _tc.versionPathPrefix + _tc.model.directoryPath + '/' + _tc.fdbusDeploymentHeaderFile
    }

    def String fdbusDeploymentSourceFile(FTypeCollection _tc) {
        return _tc.elementName + "FDBusDeployment.cpp"
    }

    def String fdbusDeploymentSourcePath(FTypeCollection _tc) {
        return _tc.versionPathPrefix + _tc.model.directoryPath + '/' + _tc.fdbusDeploymentSourceFile
    }

    def String fdbusProxyHeaderFile(FInterface fInterface) {
        return fInterface.elementName + "FDBusProxy.hpp"
    }

    def String fdbusProxyHeaderPath(FInterface fInterface) {
        return fInterface.versionPathPrefix + fInterface.model.directoryPath + '/' + fInterface.fdbusProxyHeaderFile
    }

    def String fdbusProxySourceFile(FInterface fInterface) {
        return fInterface.elementName + "FDBusProxy.cpp"
    }

    def String fdbusProxySourcePath(FInterface fInterface) {
        return fInterface.versionPathPrefix + fInterface.model.directoryPath + '/' + fInterface.fdbusProxySourceFile
    }

    def String fdbusProxyClassName(FInterface fInterface) {
        return fInterface.elementName + 'FDBusProxy'
    }
    ...
    def String getEventIdentifier(FBroadcast _broadcast, PropertyAccessor _accessor) {
        val Integer value = _accessor.getFDBusEventID(_broadcast)
        if (value !== null)
            return "CommonAPI::FDBus::event_id_t(0x" + value.toHexString + ")"
        return "UNDEFINED_EVENT_ID"
    }

    def List<String> getEventGroups(FBroadcast _broadcast, PropertyAccessor _accessor) {
        val List<Integer> value = _accessor.getFDBusEventGroups(_broadcast)
        if (value !== null)
    ...
    def String isReliable(FBroadcast _broadcast, PropertyAccessor _accessor) {
        val Boolean value = _accessor.getFDBusReliable(_broadcast)
        if (value !== null)
    ...
    def String getReliabilityType(FBroadcast _broadcast, PropertyAccessor _accessor) {
        if (_broadcast.isReliable(_accessor) === "true") {
            return "CommonAPI::FDBus::reliability_type_e::RT_RELIABLE"
        } else {
            return "CommonAPI::FDBus::reliability_type_e::RT_UNRELIABLE"
        }
    }

    def String isNotifierReliable(FAttribute _attribute, PropertyAccessor _accessor) {
        val Boolean value = _accessor.getFDBusNotifierReliable(_attribute)
        if (value !== null)
            return value.toString
        return "false"
    }
    ...
    def String getMethodIdentifier(FMethod _method, PropertyAccessor _accessor) {
        val Integer value = _accessor.getFDBusMethodID(_method)
        if (value !== null)
            return "CommonAPI::FDBus::method_id_t(0x" + value.toHexString + ")"
        return "UNDEFINED_METHOD_ID"
    }

    def String isReliable(FMethod _method, PropertyAccessor _accessor) {
        val Boolean value = _accessor.getFDBusReliable(_method)
        if (value !== null)
            return value.toString
        return "false"
    }
    ...
    def String isLittleEndian(FMethod _method, PropertyAccessor _accessor) {
        return _accessor.getFDBusEndianess(_method)
    }

    def String getDeployment(FBasicTypeId _type) {
        var String itsDeployment = "CommonAPI::FDBus::IntegerDeployment<"
    ...
    def String getGetterIdentifier(FAttribute _attribute, PropertyAccessor _accessor) {
        val Integer value = _accessor.getFDBusGetterID(_attribute)
        var String getter = "0x0"
        if (value !== null)
            getter = "0x" + value.toHexString

        return "CommonAPI::FDBus::method_id_t(" + getter + ")"
    }

    def String getSetterIdentifier(FAttribute _attribute, PropertyAccessor _accessor) {
        val Integer value = _accessor.getFDBusSetterID(_attribute)
        if (value !== null)
            return "CommonAPI::FDBus::method_id_t(0x" + value.toHexString + ")"
    ...
    def String getNotifierIdentifier(FAttribute _attribute, PropertyAccessor _accessor) {
        val Integer value = _accessor.getFDBusNotifierID(_attribute)
        if (value !== null)
            return "CommonAPI::FDBus::event_id_t(0x" + value.toHexString + ")"
    ...
    def List<String> getNotifierEventGroups(FAttribute _attribute, PropertyAccessor _accessor) {
        val List<Integer> value = _accessor.getFDBusEventGroups(_attribute)
        if (value !== null)
            return value.map[id|"CommonAPI::FDBus::eventgroup_id_t(0x" + id.toHexString + ")"]
    ...
    def String getEndianess(FAttribute _attribute, PropertyAccessor _accessor) {
        return _accessor.getFDBusEndianess(_attribute)
    }

    def String getEndianess(FBroadcast _broadcast, PropertyAccessor _accessor) {
        return _accessor.getFDBusEndianess(_broadcast)
    }
    ...
    def String isGetterReliable(FAttribute _attribute, PropertyAccessor _accessor) {
        val Boolean value = _accessor.getFDBusGetterReliable(_attribute)
        if (value !== null)
            return value.toString
        return "false"
    }
    ...
    def String isSetterReliable(FAttribute _attribute, PropertyAccessor _accessor) {
        val Boolean value = _accessor.getFDBusSetterReliable(_attribute)
        if (value !== null)
            return value.toString
        return "false"
    }
    ...
    def dispatch String getDeploymentType(FTypedElement _typedElement, FTypeCollection _interface, boolean _useTc) {
        if (_typedElement.array)
            return "CommonAPI::FDBus::ArrayDeployment< " + _typedElement.type.getDeploymentType(_interface, _useTc) +
                " >"
    ...
    def dispatch String getDeploymentType(FIntegerInterval _interval, FTypeCollection _interface, boolean _useTc) {
        return "CommonAPI::FDBus::IntegerDeployment<int32_t>"
    }
    def dispatch String getDeploymentType(FBasicTypeId _type, FTypeCollection _interface, boolean _useTc) {
        if (_type == FBasicTypeId.STRING)
            return "CommonAPI::FDBus::StringDeployment"
        else if (_type == FBasicTypeId.BYTE_BUFFER)
            return "CommonAPI::FDBus::ByteBufferDeployment"
    ...
    def String generateDeployedStubSignature(FMethod _method, FInterface _interface, PropertyAccessor _accessor) {
        ...
        arguments += ", " + _method.elementName + "FDBusReply_t _reply"
        return arguments
    }

    def generateFDBusStubReturnSignature(FMethod _method, FInterface _interface, PropertyAccessor _accessor) {
        var signature = ""
    ...
    def generateArgumentsToFDBusStub(FMethod _method, PropertyAccessor _accessor) {
    ...
    def String getDeploymentRef(FTypedElement _typedElement, FModelElement _element, FTypeCollection _tc, PropertyAccessor _accessor) {
        ...
        if (_typedElement.type.derived !== null) {
            ...
            if (_typedElement.array)
                elemType = "CommonAPI::FDBus::ArrayDeployment< " + elemType + " >"
        } else {
    ...
    def dispatch Set<String> getDeploymentInputIncludes(FArrayType _array, PropertyAccessor _accessor) {
        ...
        ret.add(fdbusDeploymentHeaderPath(_array.eContainer as FTypeCollection))
    ...
    def dispatch Set<String> getDeploymentInputIncludes(FType _type, PropertyAccessor _accessor) {
        var Set<String> ret = new HashSet<String>()
        ret.add(fdbusDeploymentHeaderPath(_type.eContainer as FTypeCollection))
        return ret
    }

    def dispatch Set<String> getDeploymentInputIncludes(FTypeDef _typeDef, PropertyAccessor _accessor) {
        var Set<String> ret = new HashSet<String>()
        ret.add(fdbusDeploymentHeaderPath(_typeDef.eContainer as FTypeCollection))
    ...
    def dispatch Set<String> getDeploymentInputIncludes(FStructType _struct, PropertyAccessor _accessor) {
        var Set<String> ret = new HashSet<String>()
        ret.add(fdbusDeploymentHeaderPath(_struct.eContainer as FTypeCollection))
    ...
    def dispatch Set<String> getDeploymentInputIncludes(FUnionType _union, PropertyAccessor _accessor) {
        var Set<String> ret = new HashSet<String>()
        ret.add(fdbusDeploymentHeaderPath(_union.eContainer as FTypeCollection))
    ...
    def dispatch Set<String> getDeploymentInputIncludes(FMapType _map, PropertyAccessor _accessor) {
        var Set<String> ret = new HashSet<String>()
        ret.add(fdbusDeploymentHeaderPath(_map.eContainer as FTypeCollection))
    ...
    def dispatch Set<String> getDeploymentInputIncludes(FInterface _interface, PropertyAccessor _accessor) {
        ...
        for (x : _interface.attributes) {
            ...
            if(_accessor.getOverwriteAccessor(x).hasSpecificDeployment(x) || (x.array && _accessor.getOverwriteAccessor(x).hasDeployment(x))) {
                ret.add(_interface.fdbusDeploymentHeaderPath)
            }
        }
